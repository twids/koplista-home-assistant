...
async def async_handle_add_item_intent(intent_obj: intent.Intent) -> intent.IntentResponse:
    """Handle the add item intent."""
...
def async_setup_intents(hass: HomeAssistant) -> None:
    ...
    intent.async_register(hass, intent.IntentHandler(INTENT_ADD_ITEM, async_handle_add_item_intent))
